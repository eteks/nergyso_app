...
public class FourthFragment extends Fragment implements  Download_data.download_complete{
    ...
    FourthFragment.PaginationAdapter adapter;
...
//        final ProgressBar progressBar = new ProgressBar(getActivity());
        ...
        adapter = new FourthFragment.PaginationAdapter(getActivity());
...
//            loadFirstPage();
    ...
    public class PaginationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case LOADING:
                    ...
                    viewHolder = new FourthFragment.PaginationAdapter.LoadingVH(v2);
                    break;
            }
            return viewHolder;
        }
        ...
        private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
            ...
            viewHolder = new FourthFragment.PaginationAdapter.NewsVH(v1);
...
//        Movie movie = movies.get(position);
            ...
            switch (getItemViewType(position)) {
                case ITEM:
                    FourthFragment.PaginationAdapter.NewsVH newsVH = (FourthFragment.PaginationAdapter.NewsVH) holder;
