...
public class ImageFragment extends Fragment implements Download_data.download_complete{
    ...
    ImageFragment.PaginationAdapter adapter;
    ViewPager viewPager;
    String SERVER_URL;
    String IMAGE_URL;
    RecyclerView rv;
...
//        int id = getActivity().getIgetIntExtra("id", 0);
        ...
        adapter = new ImageFragment.PaginationAdapter(getActivity());
...
//                    Toast.makeText(context, "you clicked image " + (position + 1), Toast.LENGTH_LONG).show();
    ...
    public class PaginationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case LOADING:
                    ...
                    viewHolder = new ImageFragment.PaginationAdapter.LoadingVH(v2);
                    break;
            }
            return viewHolder;
        }
        ...
        private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
            ...
            viewHolder = new ImageFragment.PaginationAdapter.NewsVH(v1);
...
//        Movie movie = movies.get(position);
            ...
            switch (getItemViewType(position)) {
                case ITEM:
                    ImageFragment.PaginationAdapter.NewsVH newsVH = (ImageFragment.PaginationAdapter.NewsVH) holder;
