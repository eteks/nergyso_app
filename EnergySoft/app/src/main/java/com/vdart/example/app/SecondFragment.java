        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case LOADING:
                    ...
                    viewHolder = new SecondFragment.PaginationAdapter.LoadingVH(v2);
                    break;
            }
            return viewHolder;
        }
...
//        Movie movie = movies.get(position);
            ...
            switch (getItemViewType(position)) {
                case ITEM:
                    SecondFragment.PaginationAdapter.NewsVH newsVH = (SecondFragment.PaginationAdapter.NewsVH) holder;
