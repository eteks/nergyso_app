...
public class FullNews extends AppCompatActivity implements Download_data.download_complete{
    ...
    WebView full_text_news_description;
    int ONE_TIME = 0, TOTAL_PAGES = 0;
    String RECENT_NEWS_URL ;
    Toolbar toolbar;
    private static ViewPager mPager;
    private static ScrollView mScrollView;
    TextView full_news_title, full_news_description;
...
//            myImage.setImageResource(images.get(position));
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        switch (item.getItemId())
        {
            ...
            case R.id.gallery:
                intent = new Intent(FullNews.this,EventGallery.class);
                startActivity(intent);
                return true;


            case R.id.ceomsg:
                intent = new Intent(FullNews.this,CeomessageActivity.class);
                startActivity(intent);
                return true;

            case R.id.action_notification:
                intent = new Intent(FullNews.this,NotificationMain.class);
                startActivity(intent);
                return true;
